    ...
    return (
        <>
            <div className=" min-h-screen flex justify-center py-12">
                <div className="max-w-6xl w-full bg-gray-50 shadow-lg rounded-lg p-10 md:flex md:gap-12">
                    ...
                    <div className="md:w-1/2 bg-blue-600 text-white p-8 rounded-lg flex flex-col justify-between text-center shadow-2xl h-[700px] z-20 relative">
                        <div>
                        ...
                        <a
                            ...
                            className="mx-auto bg-orange-500 text-white flex items-center gap-2 py-2 px-4 rounded-lg shadow-lg hover:bg-orange-600 transition-all text-lg font-bold"
                        >
