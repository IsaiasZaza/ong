  ...
  return (
    <section className="py-8 bg-white">
      <div className="text-center">
        <h2 className="text-xl font-bold text-orange-600 mb-8 md:mb-12">
      ...
      <div className="flex flex-col md:flex-row flex-wrap justify-center items-center gap-8 md:gap-12 lg:gap-24">
        ...
        <div className="flex flex-col items-center">
          <div className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 bg-blue-300 rounded-full flex items-center justify-center">
            <img
