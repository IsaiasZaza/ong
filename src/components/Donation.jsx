    ...
    return (
        <div className="w-full">
            ...
            <section className="bg-white py-12 text-center">
                ...
                <p className="text-blue-800 mb-6 w-1/2 mx-auto mt-4 ">
            ...
            <section className="bg-blue-100 py-16 text-center">
                <h3 className="text-blue-700 text-3xl font-bold mb-8">
                    Comemore com propósito
                </h3>
                <p className="text-blue-900 mb-2 w-1/3 mx-auto">
                ...
                <p className="text-blue-900 pt-8 text-xl">
                <a
                    href="#"
                    className="text-blue-600 font-bold underline hover:text-blue-800 transition duration-300 pr-1"
                >
                    Clique aqui
                </a>
