    ...
    <header className="bg-white shadow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
        <div className="flex items-center">
          <Image
            src="/kokimoto.jpg" // Substitua com o caminho do seu logo
            alt="Logo Vaga Lume"
            width={50}
            height={50}
            className="mr-3"
        ...
        <div className="hidden md:block">
          <a href="#" className="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Doe Agora</a>
        </div>
        ...
        <div className="md:hidden bg-white text-gray-800">
          <nav>
            <ul className="space-y-2 px-4 py-2">
              <li><a href="#" className="block px-4 py-2 hover:text-yellow-500">Como Doar</a></li>
              <li><a href="#" className="block px-4 py-2 hover:text-yellow-500">Quem Somos</a></li>
              <li><a href="#" className="block px-4 py-2 hover:text-yellow-500">Nossa História</a></li>
              <li><a href="#" className="block px-4 py-2 hover:text-yellow-500">O Que Fazemos</a></li>
